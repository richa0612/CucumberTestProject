...
@CucumberOptions(features = {"C:/Users/richa.pandey/workspace-cucumber/LiveProject/src/test/java/features"}, 
glue = {"steps"}, 
monochrome = true, 
...
@BeforeClass	
	public static void setUp() {
        ...
        ExtentCucumberFormatter.loadConfig(new File("src/main/java/resources/extent-config.xml"));

        // User can add the system information as follows
        ExtentCucumberFormatter.addSystemInfo("Browser Name", "Chrome");
        ExtentCucumberFormatter.addSystemInfo("Browser version", "v83.0");
